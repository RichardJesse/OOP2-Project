...
public class Mpesa {
    ...
    public String extractCheckoutRequestID(String response) {
        JSONObject jsonObject = new JSONObject(response);
        return jsonObject.getString("CheckoutRequestID");
    }

    public String extractErrorCode(String response) {
        JSONObject jsonObject = new JSONObject(response);
        return jsonObject.has("errorCode") ? jsonObject.getString("errorCode") : null;
    }

    public String extractResultCode(String response) {
        JSONObject jsonObject = new JSONObject(response);
        return jsonObject.has("ResultCode") ? jsonObject.getString("ResultCode") : null;
    }
}
